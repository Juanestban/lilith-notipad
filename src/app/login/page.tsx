...
import type { UserSession, UserSessionValidation } from '@lilith/interfaces';
...
export const metadata: Metadata = {
  title: 'notepad - app notes',
  description: 'notipad/index page - test and preview without mongodb',
};
